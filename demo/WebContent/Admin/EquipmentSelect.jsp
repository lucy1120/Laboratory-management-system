...
<body>
	<form action="EquipmentManagerServlet?act=selectEquipment" method="post">
	...
	<table>
		...
		<c:if test="${pageCur != null}">
			<td colspan="9" align="right">
				...
				第${pageCur}页&nbsp;&nbsp;
				<c:url var="url_pre" value="EquipmentManagerServlet?aact=${aact }&&ename1=${ename1}&&ecomputerroom=${ecomputerroom}&&act=selectEquipment">
					<c:param name="pageCur" value="${pageCur - 1 }"/>
				</c:url>
				<c:url var="url_next" value="EquipmentManagerServlet?aact=${aact }&&ename1=${ename1}&&ecomputerroom=${ecomputerroom}&&act=selectEquipment">
					<c:param name="pageCur" value="${pageCur + 1 }"/>
				</c:url>
				<!-- 第一页没有上一页 -->
