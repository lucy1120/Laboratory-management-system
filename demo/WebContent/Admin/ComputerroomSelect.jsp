...
<body>
	<form action="ComputerroomManagerServlet?act=selectComputerroom" method="post">
	...
	<table style="margin:0 auto;">
		...
		<c:if test="${pageCur != null}">
			<td colspan="9" align="right">
				...
				第${pageCur}页&nbsp;&nbsp;
				<c:url var="url_pre" value="ComputerroomManagerServlet?aact=${aact }&&crname1=${crname1}&&crtype=${crtype}&&act=selectComputerroom">
					<c:param name="pageCur" value="${pageCur - 1 }"/>
				</c:url>
				<c:url var="url_next" value="ComputerroomManagerServlet?aact=${aact }&&crname1=${crname1}&&crtype=${crtype}&&act=selectComputerroom">
					<c:param name="pageCur" value="${pageCur + 1 }"/>
				</c:url>
				<!-- 第一页没有上一页 -->
