...
<body>
    <div class="head">
    	<div class="out"><a href="ModifyMemberServlet?act=modify&&uid=${sessionScope.adminid}">修改个人信息</a></div>
        <img src="Admin/images/211铃铛.png" class="lingdang">
        <div class="message">
            <ul>
                <li>${requestScope.adminList[0].uname}</li>
    ...
    <div class="block1">
        <div class="left">
            <img src="Admin/images/系统管理员.png">
            <p class="name">名 字 : ${requestScope.adminList[0].uname}</p>
            <p class="id">学 号 : ${sessionScope.adminid}</p>
        </div>
        <div class="right">
            <p class="name">${requestScope.adminList[0].uname}</p>
            <p class="major">${requestScope.adminList[0].umajor}</p>
            <p class="message">
            ...
            <div class="foot">
                <div class="grade">
                    ...
                    <p>${requestScope.adminList[0].ugrade}</p>
                </div>
                <div class="grade">
                    <img src="Admin/images/专业.png">
                    <p>${requestScope.adminList[0].umajor}</p>
                </div>
                <div class="grade">
                    <img src="Admin/images/年龄.png">
                    <p>${requestScope.adminList[0].uage}</p>
                </div>
                <div class="grade">
                    <img src="Admin/images/机房设施.png">
                    <p>${requestScope.adminList[0].uclassroom}</p>
                </div>
            </div>
        </div>
    </div>
