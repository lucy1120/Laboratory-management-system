	...
	<body>
		<div class="page" id="app">
			<div class="nav-left" v-show="navLeftFlag" ref="navLeft">
				<div class="LogoName">
					<a>欢迎您：${requestScope.adminList[0].saname}</a>
				</div>
				<div class="navDiv">
					...
					<div class="nav-list">
						<ul>
							<li class="nav-tab a_active waves-effect">
								<a href="UserIndexServlet?act=index" class="li-a active" target="iframe"><i class='bx bx-home-smile'></i> 主页 </a>
							</li>
							...
							<li class="nav-tab nav-ul">
								...
								<div class="nav-box">
									<a href="UserManagerServlet?act=add&saclassroom=${requestScope.adminList[0].saclassroom}" class="li-a-a" target="iframe">增加组员</a>
								</div>
								<div class="nav-box">
									<a href="UserManagerServlet?act=delete&saclassroom=${requestScope.adminList[0].saclassroom}" class="li-a-a" target="iframe">删除组员</a>
								</div>
								<div class="nav-box">
			...
			<div class="nav-right" ref="navRight">
				...
				<div class="content-page" ref="cPage">
					<iframe name="iframe" width="100%" height="100%" frameborder="0" src="UserIndexServlet?act=index"></iframe>
				</div>
			</div>
		</div>
