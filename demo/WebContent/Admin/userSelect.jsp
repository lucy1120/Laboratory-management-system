...
<body>
	<form action="UserManagerServlet?act=selectUser" method="post">
	...
	<table>
		...
		<c:if test="${pageCur != null}">
			<td colspan="9" align="right">
				...
				第${pageCur}页&nbsp;&nbsp;
				<c:url var="url_pre" value="UserManagerServlet?aact=${aact }&&uname1=${uname1}&&umajor=${umajor}&&act=selectUser">
					<c:param name="pageCur" value="${pageCur - 1 }"/>
				</c:url>
				<c:url var="url_next" value="UserManagerServlet?aact=${aact }&&uname1=${uname1}&&umajor=${umajor}&&act=selectUser">
					<c:param name="pageCur" value="${pageCur + 1 }"/>
				</c:url>
				<!-- 第一页没有上一页 -->
