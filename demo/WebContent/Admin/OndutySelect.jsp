...
<body>
	<form action="OndutyManagerServlet?act=selectOnduty" method="post">
	<table style="margin:0 auto;border:0;" style="margin-left: -60%;">
		<tr>
	...
	<table>
		...
		<c:if test="${pageCur != null}">
			<td colspan="9" align="right">
				...
				第${pageCur}页&nbsp;&nbsp;
				<c:url var="url_pre" value="OndutyManagerServlet?aact=${aact }&&oname1=${oname1}&&oweekday=${oweekday}&&act=selectOnduty">
					<c:param name="pageCur" value="${pageCur - 1 }"/>
				</c:url>
				<c:url var="url_next" value="OndutyManagerServlet?aact=${aact }&&oname1=${oname1}&&oweekday=${oweekday}&&act=selectOnduty">
					<c:param name="pageCur" value="${pageCur + 1 }"/>
				</c:url>
				<!-- 第一页没有上一页 -->
