	...
	<script type="text/javascript">
		...
		function checkDel(uid){
  			if(window.confirm("是否删除该用户？")){
  				window.location.href="UserManagerServlet?act=deleteUser&uclassroom=${requestScope.uclassroom}&uid="+uid;
  			}
  		}
	</script>
</head>
<body>
	...
	<form action="UserManagerServlet?act=selectUserSA&uclassroom=${requestScope.uclassroom}&del=del" method="post">
		<table style="margin:0 auto;border:0;">
			<tr>
				<td style="border:none;width:300px;">
					<a style="margin-left: -20%;margin-top: 0.4%;position: absolute;">用户名：</a><input type="text" name="uname" value="${uname1}" style="margin-left: -60%;">
				</td>
				<td style="border:none;width:300px;">
